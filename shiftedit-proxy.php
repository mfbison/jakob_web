...
//config
$host = 'ftp.pacificwestgateway.com';
$username = 'cleric@pacificwestgateway.com'; // username or ftp username
$password = 'cleric1077'; // password or ftp password
...
$pasv = '1'; // true for pasv mode / false for active mode
...
$origin = $_SERVER['HTTP_ORIGIN'] ?: 'https://shiftedit.net'; // CORS origin: https://shiftedit.net
...
switch( $_POST['cmd'] ){
	...
	case 'sync':
		...
		try {
			$response['result'] = $git->run('push -u origin HEAD');
		} catch (exception $e) {
			$response['error'] = $e->getMessage();
			break;
		}
